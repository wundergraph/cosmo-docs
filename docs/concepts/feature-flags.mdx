...
<Frame caption="Feature Flag and Feature Subgraphs">
  <img src="/images/concepts/image-1.png" />
</Frame>
...
<Info>
  Learn how to use feature flags [through this
  example](/tutorial/gradual-and-experimental-feature-rollout-with-feature-flags).
</Info>
...
<Frame caption="Traffic splitting">
  <img src="/images/concepts/image-2.png" />
</Frame>
...
<Info>
  The router is not responsible for traffic splitting. Modern cloud providers /
  load-balancers support traffic splitting e.g. based on IP or custom rules and
  allows to set custom headers. On our case, we would set the `X-Feature-Flag`
  header to the name of the feature flag to enable it.
</Info>
