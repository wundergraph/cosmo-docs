...
<CardGroup cols={2}>
  <Card title="Products" icon="square-1" horizontal></Card>
  <Card title="Employee" icon="square-2" horizontal></Card>
  <Card title="Mood" icon="square-3" horizontal></Card>
  <Card title="Availability" icon="square-4" horizontal></Card>
</CardGroup>
...
<Frame>![](/images/getting-started/image-2.png)</Frame>
...
<Frame>![](/images/getting-started/image-3.png)</Frame>
