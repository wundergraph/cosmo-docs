...
<CardGroup>
  <Card title="Node.js (>= 20 LTS)" icon="node" horizontal />
  <Card
    title="Docker"
    icon="docker"
...
<CardGroup>
  <Card
    title="http://localhost:4001/graphql"
    icon="link"
    horizontal
  ...
  <Card
    title="http://localhost:4002/graphql"
    icon="link"
    horizontal
...
<CardGroup>
  <Card
    ...
    icon="cloud-sun"
    href="/getting-started/cosmo-cloud-onboarding"
    horizontal
  />
</CardGroup>
