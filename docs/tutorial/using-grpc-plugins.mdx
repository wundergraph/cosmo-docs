...
This tutorial shows you how to create a gRPC plugin subgraph from scratch using the Cosmo CLI.

You'll start by initializing a new plugin, and we'll walk you through implementation and deployment.
