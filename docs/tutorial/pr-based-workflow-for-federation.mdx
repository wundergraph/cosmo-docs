...
<Frame>
  <img src="/images/tutorial/image-1.png" alt="Cosmo GitHub App Integration" />
</Frame>
...
<Info>
  ...
  otherwise, a developer can still merge a PR with a failing check.
</Info>
...
<Frame>
  <iframe
    width="100%"
    height="400"
    src="https://www.youtube.com/embed/9lewTRpC3qM"
    title="Schema Checks with GitHub Integration"
    frameborder="0"
