...
* `router_http_client_connection_acquire_duration`: The duration that a connection took to be initialized, which includes all of DNS, TLS Handshakes, and Dialing the host.
