...
* [`router_info`](/router/metrics-and-monitoring/prometheus-metric-reference#router_http_requests_total): Info metric that provides metadata about every running router configuration.
