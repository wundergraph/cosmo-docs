...
<Frame caption="The Router connects your Clients and Subgraphs to establish a Real-time connection.">
  <img src="/images/router/image-3.png" />
</Frame>
...
<Info>
  Whenever your router updates its config at runtime, **it terminates all active
  subscriptions.** Clients should be built in a way that reconnects
