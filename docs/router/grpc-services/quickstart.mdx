---
title: "Quickstart"
description: "Quickstart for integrating gRPC services into your router."
icon: network-wired
---

## Integrating a gRPC Service

This guide will walk you through the process of integrating a gRPC service into your router.
...
```bash
wgc grpc generate Projects -p playground -i ./schema.graphql -o .
```
...
Depending on the language you are using, you might need to adjust the options. The package name needs to be the same as the one you used in the `wgc grpc generate` command.
...
Finally, start the Cosmo Router with your configuration and query your gRPC service through GraphQL:
