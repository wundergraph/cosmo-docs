...
<Info>
  Authorization directives can be used in your schema to define granular
  authorization rules on the field definition level. Documentation can be found
  at [@authenticated](/federation/directives/authenticated) and
  [@requiresScopes](/federation/directives/requiresscopes).
</Info>
