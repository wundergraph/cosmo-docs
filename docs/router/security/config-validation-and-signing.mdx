...
<Info>
  ...
  [0.74.0](https://github.com/wundergraph/cosmo/releases/tag/router%400.74.0)
</Info>
...
<Note>
  For security reasons, ensure your admission server uses HTTPS as transport
  prototcol.
</Note>
...
<Info>
  Once validation is successful, the configuration will no longer be availabe at
  the above URL and will return a `404` status code.
</Info>
