...
by the list size — only the children's costs are multiplied. Our implementation multiplies both the type weight
...
|----------------|---------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| `enabled`      | `SECURITY_COST_ANALYSIS_ENABLED`      | When true, the router calculates static cost for every operation. Required to access cost from custom modules.                                            |
...
With default list size of 10, this query costs over 10,000.
