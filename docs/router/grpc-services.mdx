...
While gRPC services provide powerful integration capabilities, there are some current limitations to be aware of when planning your implementation.
...
- Advanced gRPC configuration options
- Enhanced Federation feature support
- Subscription support for real-time data
- Expanded GraphQL schema feature compatibility

For the most up-to-date information on feature availability and roadmap, please check our [GitHub repository](https://github.com/wundergraph/cosmo).
