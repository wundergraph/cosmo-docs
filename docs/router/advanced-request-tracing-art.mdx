...
<Frame>
   <img src="/images/router/advanced-request-tracing-debug-interface.png" alt="Advanced Request Tracing interface showing GraphQL query execution with debug information and timing data" title="Advanced Request Tracing debug interface" />
</Frame>
