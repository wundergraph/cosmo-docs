...
# Edit `./plugins/hello-world/src/schema.graphql` and `./plugins/hello-world/src/main.go`

# 4️⃣ Generate the Go code for your plugin
cd plugins/hello-world && make generate

# 5️⃣ Now you can implement your gRPC resolvers in `./plugins/hello-world/src/main.go`

# ⭐ Regenerate the code, build then plugin and serve the latest config
make
```
