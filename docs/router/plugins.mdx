...
<CardGroup cols={2}>
  <Card title="Simplified Architecture" icon="cloud-arrow-up">
    Maintain fewer components with unified deployment and monitoring. You can run multiple plugins by the same router
  </Card>
  <Card title="Performance" icon="rocket">
    Achieve significantly lower latency with direct RPC-based communication. The GraphQL framework overhead is eliminated.
  </Card>
