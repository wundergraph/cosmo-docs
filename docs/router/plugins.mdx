...
gRPC plugins are extensions that run directly inside the Cosmo Router process. They implement the GraphQL resolvers using Google's Remote Procedure Call ([gRPC](https://grpc.io/)) protocol, providing:
