...
wgc router plugin init hello-world -p myproject
...
# 5️⃣ Generate the Go code for your plugin to implement the resolvers
cd plugins/hello-world && make generate

# 6️⃣ Now you can implement your gRPC resolvers in `./plugins/hello-world/src/main.go`
