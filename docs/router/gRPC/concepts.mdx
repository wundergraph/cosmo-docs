...
<Note>
gRPC integration through the Cosmo Router is <Note> Part of **Cosmo Connect** </Note>, which extends federation beyond GraphQL by supporting RPC-style services like gRPC.
</Note>
