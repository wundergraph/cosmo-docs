...
<Note>
gRPC integration through the Cosmo Router is part of **Cosmo Connect**, which extends federation beyond GraphQL by supporting RPC-style services like gRPC.
</Note>
...
graph TD
    ...
    %% Development flow
    Generated --> |"You implement"| SERVICE
