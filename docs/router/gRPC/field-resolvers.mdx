...
```go service.go
func (s *CategoryService) ResolveCategoryPopularityScore(_ context.Context, req *productv1.ResolveCategoryPopularityScoreRequest) (*productv1.ResolveCategoryPopularityScoreResponse, error) {
...
func (s *ExampleService) ResolveExample(_ context.Context, req *productv1.ResolveExampleRequest) (*productv1.ResolveExampleResponse, error) {
  results := make([]*productv1.ResolveExampleResult, 0, len(req.GetContext()))
    ...
    if reqContext.GetId() == "1" {
      ...
      results = append(results, &productv1.ResolveExampleResult{})
      continue
    }
	...
	resp := &productv1.ResolveExampleResponse{
		Result: results,
	}
