...
description: "EDFS combines the power of GraphQL Federation and Event-Driven Architecture (Kafka, NATS, SQS) to update a user GraphQL Subscription after an event occurs in your system."
icon: circle-info
sidebarTitle: Overview
---

<Frame>
  <img src="/images/router/image-8.png" />
</Frame>
...
<CardGroup>
  <Card
    title="Kafka"
    href="/router/event-driven-federated-subscriptions-edfs/kafka"
    icon="sitemap"
  />
  <Card
    title="NATS"
    href="/router/event-driven-federated-subscriptions-edfs/nats"
    icon="puzzle-piece"
  />
</CardGroup>
...
<Info>
  We do not validate whether a client is allowed to subscribe to specific events
  or topics. If this is a blocker for you, please contact us. We have ideas on
