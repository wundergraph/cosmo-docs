...
<CardGroup>
  <Card title="Kafka" href="/router/event-driven-federated-subscriptions-edfs/kafka" icon="sitemap" />
  <Card title="NATS" href="/router/event-driven-federated-subscriptions-edfs/nats" icon="puzzle-piece" />
</CardGroup>
