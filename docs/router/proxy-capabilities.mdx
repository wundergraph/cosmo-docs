...
<CardGroup>
  <Card title="Subgraph Request Headers Operations" icon="arrow-right-to-bracket" href="/router/proxy-capabilities/subgraph-request-headers-operations" horizontal />
