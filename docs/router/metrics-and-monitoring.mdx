...
* `router.engine.subscriptions`: The number of currently active subscriptions.
...
* `router.engine.messages.sent`: The number of total messages sent over subscriptions to the client.
