...
We currently support two attributes for monitoring circuit breakers. All the below mentioned metrics have the `wg_subgraph` and `wg_feature_flag` dimensions.
