...
<Info>
  ...
  accommodated with the current feature set. You can still use [Custom
  Modules](/router/custom-modules) to implement any logic yourself. You can
  aggregate, remove, or add headers as you like.
</Info>
