...
|                      | response_compression_min_size | <Icon icon="square" /> | The minimum size of the response body in bytes to enable response compression. The size is specified as a string with a number and a unit, e.g. 10KB, 1MB, 1GB                                                                               | 4KB           |
| 5mb                  |                               |                        |                                                                                                                                                                                                                                              |               |
