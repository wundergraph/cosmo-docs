...
| INTROSPECTION_ENABLED            | introspection_enabled            | <Icon icon="square" />                        | **Deprecated**, use `introspection.enabled` instead. Enables the GraphQL introspection.                                                                                                            | true                             |
...
| ENGINE_ENABLE_EXECUTION_PLAN_CACHE_RESPONSE_HEADER            | enable_execution_plan_cache_response_header            | <Icon icon="square" /> | **Deprecated**, use "enable_cache_response_headers" instead. When enabled, the Router sets the response Header "X-WG-Execution-Plan-Cache" to "HIT" or "MISS"                                                                                                                                                                               | false         |
