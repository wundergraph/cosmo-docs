...
| MCP_SERVER_PORT                | mcp.server.port               | <Icon icon="square" /> | The port where the MCP server will listen for requests                                                                                | 5025          |
| MCP_ROUTER_URL                 | mcp.router_url                | <Icon icon="square" /> | Custom URL to use for the router GraphQL endpoint in MCP. Use this when your router is behind a proxy.                                | -             |
...
| MCP_GRAPH_NAME                 | mcp.graph_name                | <Icon icon="square" /> | The name of the graph to be used by the MCP server                                                                                    | cosmo         |
