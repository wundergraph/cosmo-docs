...
| DEMO_MODE                        | demo_mode                        | <Icon icon="square" />                        | If set to true, the router will start even if no execution configuration is found, using a demo configuration instead.                                                                             |                                  |
