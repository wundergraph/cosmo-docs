...
Configure TLS client certificates for outbound connections from the router to subgraphs. See [Outbound mTLS to Subgraphs](/router/security/tls#outbound-mtls-to-subgraphs) for details.
