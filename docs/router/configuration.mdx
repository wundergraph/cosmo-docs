...
| key_id                                                                      |  <Icon icon="square-check" iconType="solid" /> | The key id, this is required as the router use JWK Sets and the key id is used to identify the correct JWK                                   |                     |
| algorithm                                                                   |  <Icon icon="square-check" iconType="solid" /> | Specify which algorithm is used for signing, supported algorithms are "HS256", "HS384", "HS512"                                               |                     |
