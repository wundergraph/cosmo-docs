...
<Card
  ...
  icon="book"
  href="https://github.com/wundergraph/connectrpc-demo"
  horizontal
>
...
Create a directory for your operations (e.g., [`services/`](https://github.com/wundergraph/connectrpc-demo/tree/main/services)). Each `.graphql` file should contain one named operation:
...
This creates [`service.proto`](https://github.com/wundergraph/connectrpc-demo/blob/main/services/service.proto) and `service.proto.lock.json` in the `./services` directory.
...
- **Learn More**: Follow the [complete tutorial](https://github.com/wundergraph/connectrpc-demo) for detailed examples
