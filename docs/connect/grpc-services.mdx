...
As part of Cosmo Connect, you can run gRPC services as independent processes that communicate with the router over the network. Unlike plugins, which run inside the router process, gRPC services are deployed separately and can live anywhere in your infrastructure.
