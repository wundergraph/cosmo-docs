...
You define a GraphQL schema contract that specifies the service interface. From this contract, Cosmo Connect generates Protocol Buffer definitions and language-specific stubs that you can use to implement your plugin or service.

This approach ensures full GraphQL Federation compliance while allowing backend services to avoid GraphQL frameworks or libraries by using straightforward gRPC.
