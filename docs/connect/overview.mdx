...
- **Router Plugins** — run inside the router process for the simplest deployment model and the lowest latency  
...
<CardGroup cols={2}>
  <Card title="Plugins" icon="plug" href="/connect/plugins">
    Extensions that run inside the router. Ideal for simple integrations and performance-critical paths.
  </Card>
...
## Next Steps
- [Plugins](/connect/plugins) — Extensions that run inside the router  
