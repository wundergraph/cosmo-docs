...
<Info>
  Schemas exceeding 10,000 characters are ignored. However, if you're interested
  in trying it out, please inform us. Our capacity is limited due to the beta
  phase.
</Info>
...
<Frame>
  <iframe
    src="https://cdn.iframe.ly/ZzcCuil?app=1"
    width="100%"
    height="800"
    allowfullscreen=""
  ></iframe>
