...
<Note>
    If a role is assigned to a single resource and that resource is deleted, the role will default to granting access to all resources in the organization.
</Note>
...
Roles in Cosmo are categorized into the following groups:
