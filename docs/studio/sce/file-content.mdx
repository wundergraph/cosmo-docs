...
<Note>
  The fields listed below are all optionals and can be included and excluded based on the
...
| `compositions`       | [`CompositionInfo[]`](#compositioninfo) or `undefined`             | A list of all the compositions caused by the check.                                           |
...
| `subgraphs`             | [`CompositionSubgraphInfo[]`](#compositionsubgraphinfo) | A collection containing all the subgraphs that colaborated to produce this composition. |
...
| Field        | Type      | Description                                                                                                        |
|--------------|-----------|--------------------------------------------------------------------------------------------------------------------|
| `message`    | `string`  | A `string` representation of the change that occurred.                                                             |
