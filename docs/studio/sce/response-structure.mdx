...
|--------------|--------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `errors`     | `string[]` or `undefined`                  | An optional collection of errors caught by the check extension. When one or more errors are returned, the schema check extension reports the result as a failure.                                           |
