...
Composition cannot add value _A_ to the federated graph because _Subgraph A_ is unaware of value _B_ and cannot accept it as a valid input.
Similarly, composition cannot remove value _B_ from the federated graph because then returning _B_ from _Subgraph B_ would be invalid. 
