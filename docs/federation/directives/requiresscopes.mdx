...
type Query {
  enumField: Enum!
    @requiresScopes(scopes: [["read:private", "read:query", "read:enum"]])
}
...
type Query @requiresScopes(scopes: [["read:query"], ["read:root"]]) {
  enumField: Enum!
    @requiresScopes(
      scopes: [["read:private", "read:field"], ["read:private", "read:object"]]
    )
}
...
type Interface {
  intField: Int!
  stringField: String!
    @requiresScopes(scopes: [["read:string"], ["read:scalar"]])
}
