...
<Info>
  Use this command whenever you make modifications to your subgraphs. It will
  report any GraphQL or composition errors before they land on production. The
  report will be made visible under [Schema Checks](/studio/schema-checks).
</Info>
...
<Info>
  This command will check any breaking changes or composition errors in case the
  subgraph is deleted.
</Info>
