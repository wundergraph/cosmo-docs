...
- `-r, --routing-url <url>`: The routing URL of your subgraph. This is the gRPC endpoint where requests will be directed, and should follow the format from the gRPC protocol (https://grpc.github.io/grpc/core/md_doc_naming.html).
