...
<CardGroup>
  ...
  <Card
    ...
    icon="github"
    horizontal
    href="https://artifacthub.io/packages/helm/cosmo-platform/cosmo"
  />
</CardGroup>
...
<CardGroup>
  <Card
    title="Helm Chart Cosmo Router"
    icon="github"
    horizontal
    href="https://github.com/wundergraph/cosmo/blob/main/helm/cosmo/charts/router/README.md"
  />
  <Card
    title="Helm Chart Cosmo Platform"
    icon="github"
    horizontal
    href="https://github.com/wundergraph/cosmo/blob/main/helm/cosmo/README.md"
  />
</CardGroup>
