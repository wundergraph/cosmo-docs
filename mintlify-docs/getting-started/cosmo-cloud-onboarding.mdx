...
<Frame>
  <img src="/images/getting-started/image-1.png" alt="Prepare your Organization" />
</Frame>
...
<Tabs>
  ...
  Expected Composition Errors**
    ...
    <Frame>
      <img src="/images/getting-started/image-4.png"/>
    </Frame>
  ...
  <Tab title="Availability">
    ...
    <Frame>
      <img src="/images/getting-started/image-5.png"/>
    </Frame>
  </Tab>
</Tabs>
...
<Frame>
  <img src="/images/getting-started/image-2.png"/>
</Frame>
...
Open [http://localhost:3002](http://localhost:3002/graphql) and run your first GraphQL operation with WunderGraph Cosmo! [<Icon icon="rocket"/>](https://apps.timwhitlock.info/emoji/tables/unicode#emoji-modal) The same playground is also available on Cosmo Cloud.
...
<Frame>
  <img src="/images/getting-started/image-3.png" />
</Frame>
